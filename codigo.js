...
$("#btn4").click(function(){
    Swal.fire({
	  ...
	  showConfirmButton: false,// quitar el boton
...
$("#btn5").click(function(){
    Swal.fire({
        ...
        animation: false,// para que no tome la animacion por defecto de sweetalert
        customClass: {
        popup: 'animated swing' // estilo de animate
    }
    });
});	
...
$("#btn6").click(function(){
    Swal.fire({
        ...
        width: 600,
        padding: '5em',
        background: '#ffffff url(img/imagen_600x500.png)', //es el fondo de la caja de dialogo
        backdrop: `
        rgba(5, 5, 25, 0.4)
