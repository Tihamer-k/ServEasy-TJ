...
$(function () {
    ...
    $(".iniciar").on("click", function () {
        ...
        } else if ((user !== "Tihamer" && pass !== "distri1" && opc !== "Distribuidora el Sol") || (user !== "Juan" && pass !== "distri2" && opc !== "Distribuidora el Sol") || (user !== "Deyvid" && pass !== "distri3" && opc !== "Distribuidora el Sol") || (user !== "Miguel" && pass !== "distri4" && opc !== "Distribuidora el Sol")) {
